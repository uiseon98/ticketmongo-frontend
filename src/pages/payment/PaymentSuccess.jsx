  ...
  if (error) {
    return (
      <div className="px-40 flex flex-1 justify-center py-20">
        <div className="layout-content-container text-center">{error}</div>
      </div>
    );
  }
  if (!booking) {
    return (
      <div className="px-40 flex flex-1 justify-center py-20">
        <div className="layout-content-container text-center">로딩 중…</div>
      </div>
    );
  }
  ...
  return (
    <div className="px-40 flex flex-1 justify-center py-5">
      <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5">
        ...
        {/* 주문 요약 */}
        <h3 className="text-[#141414] text-lg font-bold pb-2">주문 요약</h3>
                <hr className="border-t border-t-[#e0e0e0] mb-6" />
        ...
        <div className="space-y-3 mb-8">
          ...
          <div>
            ...
            <p className="text-[#141414] text-sm">{concertDateTime}</p>
          </div>
          <div>
            <p className="text-[#757575] text-sm">좌석</p>
            <p className="text-[#141414] text-sm">{seatLabels.join(", ")}</p>
          </div>
          <div>
