...
export default function BookingDetail() {
    ...
    useEffect(() => {
        ...
        const updateTime = () => {
            const result = calculateTimeUntilConcert(bookingDetail.concertDate, bookingDetail.startTime);
    ...
    const handleDownloadTicket = () => {
        if (bookingDetail.bookingStatus === BOOKING_STATUS.CANCELED) {
            showNotification('취소된 예매는 티켓을 다운로드할 수 없습니다.', NOTIFICATION_TYPE.ERROR);
            return;
        }
    ...
    const canCancelBooking = bookingDetail.bookingStatus === BOOKING_STATUS.CONFIRMED && bookingDetail.paymentStatus === 'DONE';
                ...
                <div className="max-w-6xl mx-auto px-4 py-6">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="text-right">
                            ...
                            >
                                <span className="font-mono text-lg">{bookingDetail.bookingNumber}</span>
                                {copiedBookingNumber ? (
                        ...
                        <div className="xl:col-span-3 space-y-6">
                            ...
                            <div className="mt-6 p-4 bg-gray-700 rounded-xl text-center">
                                <div className="flex justify-center items-center space-x-2 mb-2">
                                    ...
                                    <p className="text-sm font-medium text-yellow-400">알림</p>
                                </div>
                                <ul className="text-sm text-gray-300 space-y-1">
                                    <li>• 공연 당일 입장 시 신분증과 예매 확인서를 지참해 주세요</li>
