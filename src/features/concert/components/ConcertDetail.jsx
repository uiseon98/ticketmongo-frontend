          ...
          {bookingInfo.show && (
            <button
              ...
              style={{
                ...
                cursor: bookingInfo.disabled ? 'not-allowed' : 'pointer'
              }}
            >
              {bookingInfo.text}
            </button>
        ...
        <>
          ...
          <div style={infoSectionStyles}>
            ...
            <div style={infoItemStyles}>
              ...
              <span style={valueStyles}>{formatConcertDateTime()}</span>
            </div>
            ...
            <div style={infoItemStyles}>
              ...
              <span style={valueStyles}>
                🎫 {concert.totalSeats?.toLocaleString() || '정보 없음'}석
              </span>
            </div>
          </div>
          ...
          <div style={infoSectionStyles}>
            ...
            <div style={infoItemStyles}>
              ...
              <span style={valueStyles}>{formatBookingPeriod()}</span>
            </div>
