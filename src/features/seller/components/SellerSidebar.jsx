        ...
        >
            ...
            <div className="flex flex-col gap-2 py-4">
                ...
                <NavLink
                    ...
                    className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-lg text-white text-sm font-medium transition-colors ${
                        isActive ? 'bg-[#243447]' : 'hover:bg-[#243447]'
                    }`}
                >
                    {/* 홈 아이콘 (public 폴더의 SVG 사용) */}
                    <img src="/vector-00.svg" alt="홈 아이콘" className="w-6 h-6" />
                    홈 (판매자)
                </NavLink>
                ...
                {isNormalUser && (
                    ...
                    >
                        ...
                        <img src="/vector-02.svg" alt="판매자 권한 신청" className="w-6 h-6" />
                        판매자 권한 신청
                    </NavLink>
                )}
                ...
                {isSeller && (
                    <>
                        ...
                        >
                            ...
                            <img src="/vector-03.svg" alt="판매자 권한 상태" className="w-6 h-6" />
                            판매자 권한 상태
                        </NavLink>
                        ...
                        <div className="flex flex-col">
                            ...
                            >
                                ...
                                {isConcertMenuOpen ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-up"><path d="m18 15-6-6-6 6"/></svg>
                                ) : (
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down"><path d="m6 9 6 6 6-6"/></svg>
                                )}
                            </button>
                            {isConcertMenuOpen && (
                                <div className="flex flex-col pl-6 mt-1 space-y-1">
                                    ...
                                    >
                                        {/* Plus 아이콘 (SVG 직접 포함) */}
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-plus"><path d="M12 5v14M5 12h14"/></svg>
                                        콘서트 등록
                                    </NavLink>
                                    <NavLink
                                    ...
                                    >
                                        {/* List 아이콘 (SVG 직접 포함) */}
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-list"><path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/></svg>
                                        콘서트 관리
                                    </NavLink>
                                </div>
                            )}
