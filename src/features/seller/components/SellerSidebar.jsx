        ...
        >
            ...
            {isMobile && (
                <div className="flex justify-between items-center p-4 border-b border-gray-700">
                    <h2 className="text-lg font-semibold text-white">판매자 메뉴</h2>
                    <button
            ...
            <div className="flex-1 flex flex-col gap-2 p-4 overflow-y-auto">
                ...
                {user && !isAdmin && (
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `flex items-center gap-3 px-3 py-2 rounded-lg text-white text-sm font-medium transition-colors ${
                                isActive || location.pathname.startsWith('/seller/apply')
                        ...
                        <div className="flex flex-col">
                            <button
                                ...
                                className={`flex items-center justify-between px-3 py-2 rounded-lg text-white text-sm font-medium w-full text-left transition-colors hover:bg-gray-700 focus:bg-gray-700 ${
                                    (location.pathname.includes('/seller/concerts') || isConcertMenuOpen) ? 'bg-gray-700' : ''
                                }`}
                            >
                            ...
                            {/* 하위 메뉴 */}
                            {(isConcertMenuOpen || location.pathname.includes('/seller/concerts')) && (
